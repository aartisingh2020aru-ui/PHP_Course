        ...
        <div class="ps-about">
            <div class="container">
                ...
                <section class="ps-about--info">
                    <h2 class="ps-about__title">Effective and reliable <br>protection for your teeth</h2>
                    <p class="ps-about__subtitle">The brush handle fits perfectly in the hand, is slim and beautifully made.</p>
                    <div class="ps-about__extent">
                        <div class="row m-0">
                            <div class="col-12 col-md-4 p-0">
                                <div class="ps-block--about">
                                    <div class="ps-block__icon"><img src="img/icon/award-icon-2.png" alt=""></div>
                            ...
                            <div class="col-12 col-md-4 p-0">
                                <div class="ps-block--about">
                                    <div class="ps-block__icon"><img src="img/icon/dentistry-icon-2.png" alt=""></div>
                            ...
                            <div class="col-12 col-md-4 p-0">
                                <div class="ps-block--about">
                                    <div class="ps-block__icon"><img src="img/icon/toothbrush-icon-2.png" alt=""></div>
            ...
            <div class="ps-about__content">
                <!-- <section class="ps-about__banner" data-background="img/Mask-Group.jpg">
                    <div class="container">
                        <div class="ps-banner">
                            <h2 class="ps-banner__title">Hundreds of thousands of products at bargain prices</h2>
                            <div class="ps-banner__desc">Completely the needs of home medicine chest and professional offices</div><a class="ps-banner__shop" href="category-list.html">Shop now</a>
                        </div>
                    </div>
                </section> -->
                <section class="ps-about__project">
                    <div class="container">
                        ...
                        <section class="ps-section--block-grid">
                            <div class="ps-section__thumbnail"> <a class="ps-section__image" href="#"><img src="img/about/about-us-1.jpg" alt=""></a></div>
                            <div class="ps-section__content">
                                <h3 class="ps-section__title">Top quality products and proven suppliers with quality certificates!</h3>
                                <div class="ps-section__subtitle">They have CEE 2020 certificate.</div>
                                <div class="ps-section__desc">Hundreds of thousands of products at bargain prices. Completely the needs of home medicine chest and professional offices. Effective and reliable protection for your teeth. The brush handle fits perfectly in the hand, is slim and beautifully made.</div>
                        ...
                        <section class="ps-section--block-grid row-reverse">
                            <div class="ps-section__thumbnail"> <a class="ps-section__image" href="#"><img src="img/about/about-us-2.jpg" alt=""></a></div>
                            <div class="ps-section__content">
                                <h3 class="ps-section__title">Many years of experience and a high level of consumer confidence</h3>
                                <div class="ps-section__subtitle">Developed for over 30 years on the market</div>
                                <div class="ps-section__desc">There are many variations of passages of Lorem Ipsum available, but the majority have suffered altevration in some form, by injected humour, or randomised words which don’t look even slightly believable.</div>
                                <ul class="ps-section__list">
                        ...
                        <section class="ps-section--block-grid">
                            <div class="ps-section__thumbnail"> <a class="ps-section__image" href="#"><img src="img/about/about-us-3.jpg" alt=""></a></div>
                            <div class="ps-section__content">
                                <h3 class="ps-section__title">Just a few seconds to measure your body temperature. Up to 5 users!</h3>
                                <div class="ps-section__subtitle">The battery lasts up to 2 years.</div>
                                <div class="ps-section__desc">There are many variations of passages of Lorem Ipsum available, but the majority have suffered altevration in some form, by injected humour, or randomised words which don’t look even slightly believable.</div>
                                <ul class="ps-section__list">
                                    <li>Study history up to 30 days</li>
                                    <li>Up to 5 users simultaneously</li>
                                ...
                                <div class="ps-banner__thumnail">
                                    <div style="display:none;" id="video1">
                                        <video class="lg-video-object lg-html5" controls="" preload="none">
                                            <source src="img/video.mp4" type="video/mp4">Your browser does not support HTML5 video.
                                        </video>
                                    </div><img class="ps-banner__image" src="img/about/goby-tD3GaS9ysF4-unsplash-1.jpg" alt="">
                                    <div id="ps-video-gallery">
                                        <div class="video" data-html="#video1" data-poster="img/about/goby-tD3GaS9ysF4-unsplash-1.jpg"><a href="">
