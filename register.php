            ...
            <div class="container">
                ...
                <div class="row d-flex justify-content-center">
                    <div class="col-5 border-1">
                        <form action="controllers-database/registration.php" method="post">
                            <div class="container-form">

                                <div class="ps-form--contact border border-black p-4 rounded">
                                    <h2 class="ps-form__title text-center text-black">Registration Form</h2>
                                    <div class="row">

                                        <div class="col-12 col-md-12 mb-4">
                                            <div class="ps-form__group">
                                                <input class="form-control ps-form__input" type="text" placeholder="first Name" name="first_name">
                                            </div>
                                        </div>
                                        <div class="col-12 col-md-12 mb-4">
                                            <div class="ps-form__group">
                                                <input class="form-control ps-form__input" type="text" placeholder="last Name" name="last_name">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12 col-md-12 mb-4">
                                            <div class="ps-form__group">
                                                <input class="form-control ps-form__input" type="password" placeholder="Password" name="password">
                                            </div>
                                        </div>

                                        <div class="col-12 col-md-12 mb-4">
                                            <div class="ps-form__group">
                                                <input class="form-control ps-form__input" type="text" placeholder="Phone no" name="phone">
                                            </div>
                                        </div>

                                        <div class="col-12 col-md-12">
                                            <div class="ps-form__group">
                                                <select class="form-control ps-form__input" name="state">
                                    ...
                                    <div class="ps-form__submit d-flex justify-content-center">
                                        <button class="ps-btn ps-btn--warning">Submit</button>
                                    </div>
                                </div>
